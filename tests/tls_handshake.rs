...
static SERVER_REPLY1: &[u8] = &[
    ...
    #[test]
    fn test_sslv3_record_serverhello() {
        let empty = &b""[..];
        let bytes = &[
            0x16, 0x03, 0x00, 0x00, 0x3a, 0x02, 0x00, 0x00, 0x36, 0x03, 0x00, 0xf9, 0x5d, 0x75,
            0x87, 0x68, 0x2b, 0x49, 0x8c, 0x72, 0xf8, 0x72, 0x3a, 0xb7, 0xb6, 0x79, 0x02, 0xee,
            0x3c, 0xa9, 0xfc, 0x12, 0x90, 0xea, 0xab, 0x29, 0x46, 0xcc, 0xc2, 0x0d, 0xee, 0x12,
            0x93, 0x10, 0xb3, 0xdc, 0xd8, 0x87, 0x0b, 0x14, 0xa0, 0x3a, 0x34, 0x90, 0xeb, 0x26,
            0xec, 0x92, 0xe2, 0x42, 0x00, 0x10, 0x00,
        ];
        let expected = TlsPlaintext {
            hdr: TlsRecordHeader {
                record_type: TlsRecordType::Handshake,
            ...
            msg: vec![TlsMessage::Handshake(TlsMessageHandshake::ServerHello(
                TlsServerHelloContents {
                    version: TlsVersion::Ssl30,
                    random: &[
                        0xf9, 0x5d, 0x75, 0x87, 0x68, 0x2b, 0x49, 0x8c, 0x72, 0xf8, 0x72, 0x3a,
                        0xb7, 0xb6, 0x79, 0x02, 0xee, 0x3c, 0xa9, 0xfc, 0x12, 0x90, 0xea, 0xab,
                        0x29, 0x46, 0xcc, 0xc2, 0x0d, 0xee, 0x12, 0x93,
                    ],
                    session_id: Some(&[
                        0xb3, 0xdc, 0xd8, 0x87, 0x0b, 0x14, 0xa0, 0x3a, 0x34, 0x90, 0xeb, 0x26,
                        0xec, 0x92, 0xe2, 0x42,
                    ]),
                    cipher: TlsCipherSuiteID(0x010),
                    compression: TlsCompressionID(0),
                    ext: None,
                },
            ))],
